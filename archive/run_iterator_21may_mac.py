...
RESULTS_FILE = "/Users/ai/talk/pipeline/results_2026-05-21.json"
OGG_DIR = "/Users/ai/talk"

MAX_DIALOGUES = 100  # Лимит на тестовый запуск
...
def get_emotion_tag(min_time, max_time):
    try:
        ...
        target_audio = os.path.join(OGG_DIR, audio_file)
        tag, is_conflict, audio_path = analyze_emotion_and_tag(min_time, max_time, target_audio)
        if torch.backends.mps.is_available():
            torch.mps.empty_cache()
